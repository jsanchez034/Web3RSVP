...
export class Account extends Entity {
  ...
  get totalAttendeeEvents(): BigInt {
    let value = this.get("totalAttendeeEvents");
    return value!.toBigInt();
  }

  set totalAttendeeEvents(value: BigInt) {
    this.set("totalAttendeeEvents", Value.fromBigInt(value));
  }
  ...
  get attendeeEvents(): Array<string> | null {
    let value = this.get("attendeeEvents");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set attendeeEvents(value: Array<string> | null) {
    if (!value) {
      this.unset("attendeeEvents");
    } else {
      this.set("attendeeEvents", Value.fromStringArray(<Array<string>>value));
    }
  }
}
